...
if ( ! function_exists( 'plamen_core_add_product_list_variation_info_below' ) ) {
	function plamen_core_add_product_list_variation_info_below( $variations ) {
		$variations['info-below'] = esc_html__( 'Info Below', 'plamen-core' );
		
		return $variations;
	}
	
	add_filter( 'plamen_core_filter_product_list_layouts', 'plamen_core_add_product_list_variation_info_below' );
}

if ( ! function_exists( 'plamen_core_register_shop_list_info_below_actions' ) ) {
	function plamen_core_register_shop_list_info_below_actions() {
	...
	add_action( 'plamen_core_action_shop_list_item_layout_info-below', 'plamen_core_register_shop_list_info_below_actions' );
}