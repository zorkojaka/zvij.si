...
if ( ! function_exists( 'plamen_core_add_h6_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function plamen_core_add_h6_typography_options( $page ) {
		...
		if ( $page ) {
			$h6_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h6',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H6 Typography', 'plamen-core' ),
					'description' => esc_html__( 'Set values for Heading 6 HTML element', 'plamen-core' )
				)
			);
	...
	add_action( 'plamen_core_action_after_typography_options_map', 'plamen_core_add_h6_typography_options' );
}