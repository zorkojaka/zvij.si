<?php
class PlamenCoreElementorInstagramList extends \Elementor\Widget_Base {
	...
	public function set_object() {
		$this->object = qode_framework_get_framework_root()->get_shortcodes()->get_shortcode('plamen_core_instagram_list');
	}
...
if( qode_framework_is_installed( 'instagram' ) ) {
	plamen_core_get_elementor_widgets_manager()->register_widget_type(new PlamenCoreElementorInstagramList());
}