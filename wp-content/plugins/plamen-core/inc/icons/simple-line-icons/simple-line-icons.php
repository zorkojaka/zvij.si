...
if ( ! function_exists( 'plamen_core_add_simple_line_icons_to_collection' ) ) {
	function plamen_core_add_simple_line_icons_to_collection( $icons ) {
		$icons[] = 'PlamenCoreSimpleLineIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'plamen_core_add_simple_line_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PlamenCoreSimpleLineIconsPack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return PLAMEN_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/' . $this->get_base() . '.min.css';
		}
