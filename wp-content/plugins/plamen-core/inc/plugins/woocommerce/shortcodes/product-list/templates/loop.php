<?php if ( $query_result->have_posts() ) {
	while ( $query_result->have_posts() ) : $query_result->the_post();
		...
		$params['wrapper_styles']  = $this_shortcode->get_wrapper_styles( $params );

		plamen_core_list_sc_template_part( 'plugins/woocommerce/shortcodes/product-list', 'layouts/' . $layout, '', $params );
