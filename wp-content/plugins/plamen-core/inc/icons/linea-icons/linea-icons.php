...
if ( ! function_exists( 'plamen_core_add_linea_icons_to_collection' ) ) {
	function plamen_core_add_linea_icons_to_collection( $icons) {
		$icons[] = 'PlamenCoreLineaIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'plamen_core_add_linea_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PlamenCoreLineaIconsPack extends QodeFrameworkIconPack {
