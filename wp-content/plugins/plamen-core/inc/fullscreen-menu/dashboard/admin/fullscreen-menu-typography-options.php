...
if ( ! function_exists( 'plamen_core_fullscreen_menu_typography_options' ) ) {
	function plamen_core_fullscreen_menu_typography_options( $page ) {
		...
		if ( $page ) {
			...
			$typography_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Fullscreen Menu Typography', 'plamen-core' )
				)
			);
	...
	add_action( 'plamen_core_action_after_fullscreen_menu_options_map', 'plamen_core_fullscreen_menu_typography_options', 15 );
}