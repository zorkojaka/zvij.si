(function ($) {
        ...
        updateMapRadius: function ($geoLocationRadius, $slider) {
            ...
            $slider.noUiSlider.on('set', function (values) {
                ...
                if (typeof geoLocation === 'object') {
                    qodefCore.qodefGoogleMultipleMap.setGeoLocationRadius($geoLocation, values, sliderEventCount > 0);
                    sliderEventCount++;
                }
            });
        },
    ...
    qodefCore.qodefInitGeoLocationRangeSlider = qodefInitGeoLocationRangeSlider;
    ...
    var qodefGoogleMultipleMap = {
        ...
        addMultipleMarkers: function (markersData) {
            ...
            for (var i = 0; i < len; i++) {
                ...
                var customMarker = new qodefCore.CustomMarker({
                    position: latLng,
                    map: map,
                                ...
                                if (status === google.maps.GeocoderStatus.OK && typeof results === 'object') {
                                    ...
                                    if (typeof cityName === 'string') {
                                        ...
                                        if (listHolder) {
                                            ...
                                            qodefCore.qodefInitGeoLocationRangeSlider.showRangeSlider(latlng, true);
                                        }
                                    }
                                }
                            });
        ...
        setGeoLocationRadius: function (forwardLocation, radius, isActive) {
            ...
            if (typeof forwardLocation === 'object' && typeof google === 'object') {
                ...
                qodefCore.qodefInitGeoLocationRangeSlider.disableItemsOutOfRange(itemsInArea);
            }
        },
            ...
            if (typeof google === 'object' && typeof google.maps.places === 'object') {
                ...
                autocomplete.addListener('place_changed', function () {
                    ...
                    if (listHolder) {
                        ...
                        qodef.body.trigger('plamen_trigger_after_autocomplete_places', [listHolder]);

                        // ReInit listing list and map
                        qodefCore.qodefInitGeoLocationRangeSlider.reset();
                    }
                });
            }
        }
    ...
    var qodefInitMultipleListingMap = {
        init: function () {
            ...
            if ($mapHolder.length) {
                qodefCore.qodefGoogleMultipleMap.getDirectoryItemsAddresses({
                    mapHolder: 'qodef-multiple-map-holder',
                    hasFilter: true
                });
            }
    ...
    qodefCore.qodefInitMultipleListingMap = qodefInitMultipleListingMap;
    ...
    qodefCore.qodefReinitMultipleGoogleMaps = qodefReinitMultipleGoogleMaps;
