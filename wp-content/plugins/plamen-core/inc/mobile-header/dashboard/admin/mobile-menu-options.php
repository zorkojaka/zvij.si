...
if ( ! function_exists( 'plamen_core_mobile_header_menu_options' ) ) {
	function plamen_core_mobile_header_menu_options( $page ) {
		...
		if ( $page ) {
			$mobile_menu_tab = $page->add_tab_element(
				array(
					...
					'icon'  => 'fa fa-cog',
					'title' => esc_html__( 'Mobile Menu Settings', 'plamen-core' )
				)
			);
			...
			$typography_section = $mobile_menu_tab->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Mobile Menu Typography', 'plamen-core' ),
					'dependency' => array(
						'hide' => array(
							'qodef_mobile_header_layout' => array(
								'values'        => plamen_core_dependency_for_mobile_menu_typography_options(),
	...
	add_action( 'plamen_core_action_after_mobile_header_options_map', 'plamen_core_mobile_header_menu_options' );
}