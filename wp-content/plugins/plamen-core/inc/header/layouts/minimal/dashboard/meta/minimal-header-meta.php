...
if ( ! function_exists( 'plamen_core_add_minimal_header_meta' ) ) {
	function plamen_core_add_minimal_header_meta( $page ) {
	...
	add_action( 'plamen_core_action_after_page_header_meta_map', 'plamen_core_add_minimal_header_meta' );
}