...
if ( ! function_exists( 'plamen_core_add_elegant_icons_to_collection' ) ) {
	function plamen_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'PlamenCoreElegantIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'plamen_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PlamenCoreElegantIconsPack extends QodeFrameworkIconPack {
