...
3. ~~MailerLite aktivacija~~ **Urejeno (11. 7.)** — ključi vpisani, sinhronizacija E2E testirana. Ostane post-launch: unsubscribe webhook (secret podprt v configu, REST endpoint v zvij-core še ni implementiran) in avtentikacija domene pred prvo kampanjo.
