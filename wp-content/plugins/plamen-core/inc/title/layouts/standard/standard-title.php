...
class PlamenCoreStandardTitle extends PlamenCoreTitle {
	...
	function add_inline_styles( $style ) {
		...
		$color      = plamen_core_get_post_value_through_levels( 'qodef_page_title_subtitle_color' );
		$top_margin = plamen_core_get_post_value_through_levels( 'qodef_page_title_subtitle_top_margin' );
