...
if ( ! class_exists( 'PlamenCoreShortcodes' ) ) {
	class PlamenCoreShortcodes {
		...
		function init() {
			...
			include_once PLAMEN_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once PLAMEN_CORE_SHORTCODES_PATH . '/shortcode.php';
			include_once PLAMEN_CORE_SHORTCODES_PATH . '/list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'plamen_core_filter_register_shortcodes', $shortcodes = array() );
	...
	PlamenCoreShortcodes::get_instance();
}