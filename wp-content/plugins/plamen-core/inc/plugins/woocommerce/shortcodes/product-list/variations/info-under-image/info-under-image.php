...
if ( ! function_exists( 'plamen_core_add_product_list_variation_info_under_image' ) ) {
    function plamen_core_add_product_list_variation_info_under_image( $variations ) {
        $variations['info-under-image'] = esc_html__( 'Info Under Image', 'plamen-core' );

        return $variations;
    }

    add_filter( 'plamen_core_filter_product_list_layouts', 'plamen_core_add_product_list_variation_info_under_image' );
}

if ( ! function_exists( 'plamen_core_register_shop_list_info_under_image_actions' ) ) {
    function plamen_core_register_shop_list_info_under_image_actions() {
    ...
    add_action( 'plamen_core_action_shop_list_item_layout_info-under-image', 'plamen_core_register_shop_list_info_under_image_actions' );
}