...
if ( ! function_exists( 'plamen_core_add_linear_icons_to_collection' ) ) {
	function plamen_core_add_linear_icons_to_collection( $icons ) {
		$icons[] = 'PlamenCoreLinearIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'plamen_core_add_linear_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PlamenCoreLinearIconsPack extends QodeFrameworkIconPack {
