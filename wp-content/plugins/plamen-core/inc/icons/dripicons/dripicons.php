...
if ( ! function_exists( 'plamen_core_add_dripicons_to_collection' ) ) {
	function plamen_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'PlamenCoreDripiconsIconPack';
		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'plamen_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PlamenCoreDripiconsIconPack extends QodeFrameworkIconPack {
