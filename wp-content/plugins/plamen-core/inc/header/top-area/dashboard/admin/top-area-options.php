...
if ( ! function_exists( 'plamen_core_add_top_area_options' ) ) {
	function plamen_core_add_top_area_options( $page, $general_header_tab ) {

		$top_area_section = $general_header_tab->add_section_element(
			array(
				'name'        => 'qodef_top_area_section',
				'title'       => esc_html__( 'Top Area', 'plamen-core' ),
				'description' => esc_html__( 'Options related to top area', 'plamen-core' ),
				'dependency'  => array(
					'hide' => array(
	...
	add_action( 'plamen_core_action_after_header_options_map', 'plamen_core_add_top_area_options', 20, 2 );
}