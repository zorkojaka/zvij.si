...
if ( ! function_exists( 'plamen_core_add_font_awesome_to_collection' ) ) {
	function plamen_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'PlamenCoreFontAwesomePack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'plamen_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class PlamenCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return PLAMEN_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function get_new_icons_list() {
			$icons     = '';
			$new_icons = @file_get_contents( PLAMEN_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
